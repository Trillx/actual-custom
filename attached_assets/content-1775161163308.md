[Skip to main content](https://actualbudget.org/docs/budgeting/rules/#__docusaurus_skipToContent_fallback)
...
## How the Rules Work [​](https://actualbudget.org/docs/budgeting/rules/\#how-the-rules-work "Direct link to How the Rules Work")
...
### Condition Types [​](https://actualbudget.org/docs/budgeting/rules/\#condition-types "Direct link to Condition Types")
...
### Fields [​](https://actualbudget.org/docs/budgeting/rules/\#fields "Direct link to Fields")
...
## Experimental: rule formulas [​](https://actualbudget.org/docs/budgeting/rules/\#experimental-rule-formulas "Direct link to Experimental: rule formulas")

Actual also has an experimental “Excel formula mode” that lets some **Set** actions compute their value from a formula (toggle with the **ƒ** button in the rule editor). See [Excel Formula Mode](https://actualbudget.org/docs/experimental/formulas).

## Automatic Rules [​](https://actualbudget.org/docs/budgeting/rules/\#automatic-rules "Direct link to Automatic Rules")
...
## Managing Rules [​](https://actualbudget.org/docs/budgeting/rules/\#managing-rules "Direct link to Managing Rules")

### Creating a Rule [​](https://actualbudget.org/docs/budgeting/rules/\#creating-a-rule "Direct link to Creating a Rule")
...
### Editing a Rule [​](https://actualbudget.org/docs/budgeting/rules/\#editing-a-rule "Direct link to Editing a Rule")
...
### Deleting a Rule [​](https://actualbudget.org/docs/budgeting/rules/\#deleting-a-rule "Direct link to Deleting a Rule")
...
### Viewing Rules for a Payee [​](https://actualbudget.org/docs/budgeting/rules/\#viewing-rules-for-a-payee "Direct link to Viewing Rules for a Payee")
...
### Disabling Payee(s) Automatic Rule Creation [​](https://actualbudget.org/docs/budgeting/rules/\#disabling-payees-automatic-rule-creation "Direct link to Disabling Payee(s) Automatic Rule Creation")
...
### Disabling All Automatic Rule Creation [​](https://actualbudget.org/docs/budgeting/rules/\#disabling-all-automatic-rule-creation "Direct link to Disabling All Automatic Rule Creation")
...
## Using the Rule Editor for Sophisticated Batch Editing [​](https://actualbudget.org/docs/budgeting/rules/\#using-the-rule-editor-for-sophisticated-batch-editing "Direct link to Using the Rule Editor for Sophisticated Batch Editing")
...
- [How the Rules Work](https://actualbudget.org/docs/budgeting/rules/#how-the-rules-work)
  - [Condition Types](https://actualbudget.org/docs/budgeting/rules/#condition-types)
  - [Fields](https://actualbudget.org/docs/budgeting/rules/#fields)
- [Experimental: rule formulas](https://actualbudget.org/docs/budgeting/rules/#experimental-rule-formulas)
- [Automatic Rules](https://actualbudget.org/docs/budgeting/rules/#automatic-rules)
- [Managing Rules](https://actualbudget.org/docs/budgeting/rules/#managing-rules)
  - [Creating a Rule](https://actualbudget.org/docs/budgeting/rules/#creating-a-rule)
  - [Editing a Rule](https://actualbudget.org/docs/budgeting/rules/#editing-a-rule)
  - [Deleting a Rule](https://actualbudget.org/docs/budgeting/rules/#deleting-a-rule)
  - [Viewing Rules for a Payee](https://actualbudget.org/docs/budgeting/rules/#viewing-rules-for-a-payee)
  - [Disabling Payee(s) Automatic Rule Creation](https://actualbudget.org/docs/budgeting/rules/#disabling-payees-automatic-rule-creation)
  - [Disabling All Automatic Rule Creation](https://actualbudget.org/docs/budgeting/rules/#disabling-all-automatic-rule-creation)
- [Using the Rule Editor for Sophisticated Batch Editing](https://actualbudget.org/docs/budgeting/rules/#using-the-rule-editor-for-sophisticated-batch-editing)
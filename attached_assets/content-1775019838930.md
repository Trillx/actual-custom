[Skip to main content](https://actualbudget.org/docs/getting-started/sync/#__docusaurus_skipToContent_fallback)
...
## Getting Started [​](https://actualbudget.org/docs/getting-started/sync/\#getting-started "Direct link to Getting Started")
...
- **Con:** It is not possible to turn off encryption. This is a one way process. If you would like to move back to an unencrypted file after enabling encryption, you can use the steps in the [Backup](https://actualbudget.org/docs/backup-restore/backup) and [Restore](https://actualbudget.org/docs/backup-restore/restore) sections.
...
### Setting up End-to-End Encryption [​](https://actualbudget.org/docs/getting-started/sync/\#setting-up-end-to-end-encryption "Direct link to Setting up End-to-End Encryption")
...
**Do not lose this password**. You will not be able to recover your data if you forget it. If you forget it and you still have a copy of your data locally, you can reset your key which will do a [sync reset](https://actualbudget.org/docs/getting-started/sync/#what-does-resetting-sync-mean) and generate a new key.

## What Does "Resetting Sync" Mean? [​](https://actualbudget.org/docs/getting-started/sync/\#what-does-resetting-sync-mean "Direct link to What Does \"Resetting Sync\" Mean?")
...
## Debugging Sync Issues [​](https://actualbudget.org/docs/getting-started/sync/\#debugging-sync-issues "Direct link to Debugging Sync Issues")
...
**You will rarely see these messages**, and if you do Actual will guide you through how to fix the problem. If you are still having problems, please [reach out to us](https://actualbudget.org/contact).

### This File is not a Cloud File [​](https://actualbudget.org/docs/getting-started/sync/\#this-file-is-not-a-cloud-file "Direct link to This File is not a Cloud File")
...
### Syncing Has Been Reset on This Cloud File [​](https://actualbudget.org/docs/getting-started/sync/\#syncing-has-been-reset-on-this-cloud-file "Direct link to Syncing Has Been Reset on This Cloud File")
...
When this happens, on other devices you will see an option to revert to the latest version. Simply reverting will get you syncing again. See [What Does "Resetting Sync" Mean?](https://actualbudget.org/docs/getting-started/sync/#what-does-resetting-sync-mean)

### File Needs Upload [​](https://actualbudget.org/docs/getting-started/sync/\#file-needs-upload "Direct link to File Needs Upload")
...
### Your Data is Out of Sync [​](https://actualbudget.org/docs/getting-started/sync/\#your-data-is-out-of-sync "Direct link to Your Data is Out of Sync")

Unfortunately, Actual detected an inconsistency in your synced data. This only happens if there is a bug in the syncing process, and you should never see this. If it ever does happen, doing a [sync reset](https://actualbudget.org/docs/getting-started/sync/#what-does-resetting-sync-mean) will fix it.

### Update Required [​](https://actualbudget.org/docs/getting-started/sync/\#update-required "Direct link to Update Required")
...
## Multi-user Support [​](https://actualbudget.org/docs/getting-started/sync/\#multi-user-support "Direct link to Multi-user Support")
...
- [Getting Started](https://actualbudget.org/docs/getting-started/sync/#getting-started)
- [End-to-End Encryption](https://actualbudget.org/docs/getting-started/sync/#end-to-end-encryption)
  - [Setting up End-to-End Encryption](https://actualbudget.org/docs/getting-started/sync/#setting-up-end-to-end-encryption)
- [What Does "Resetting Sync" Mean?](https://actualbudget.org/docs/getting-started/sync/#what-does-resetting-sync-mean)
- [Debugging Sync Issues](https://actualbudget.org/docs/getting-started/sync/#debugging-sync-issues)
  - [This File is not a Cloud File](https://actualbudget.org/docs/getting-started/sync/#this-file-is-not-a-cloud-file)
  - [Syncing Has Been Reset on This Cloud File](https://actualbudget.org/docs/getting-started/sync/#syncing-has-been-reset-on-this-cloud-file)
  - [File Needs Upload](https://actualbudget.org/docs/getting-started/sync/#file-needs-upload)
  - [Your Data is Out of Sync](https://actualbudget.org/docs/getting-started/sync/#your-data-is-out-of-sync)
  - [Update Required](https://actualbudget.org/docs/getting-started/sync/#update-required)
- [Multi-user Support](https://actualbudget.org/docs/getting-started/sync/#multi-user-support)
[Skip to main content](https://actualbudget.org/docs/transactions/payees/#__docusaurus_skipToContent_fallback)
...
## How Payees Work [​](https://actualbudget.org/docs/transactions/payees/\#how-payees-work "Direct link to How Payees Work")
...
Actual defaults with Category Learning enabled. You can find this setting in the bottom left corner of the Payees page. A more in depth discussion of Payee Rules and Category Learning can be found in the [Rules](https://actualbudget.org/docs/budgeting/rules/) documentation. You can turn this off for one, several or all Payees. [Learn more](https://actualbudget.org/docs/budgeting/rules/#managing-rules)

## Editing a Payee [​](https://actualbudget.org/docs/transactions/payees/\#editing-a-payee "Direct link to Editing a Payee")
...
6. Create a new rule by clicking on the "Create rule" button and the [Rule](https://actualbudget.org/docs/budgeting/rules/) creation box will appear.

## Merging Payees [​](https://actualbudget.org/docs/transactions/payees/\#merging-payees "Direct link to Merging Payees")
...
![Image searching for a Payee](https://actualbudget.org/assets/images/MergePayeesSearch-7d231695827abe064e24b6fb19431c8a.webp)

3. Click the checkbox in the table header next to the **Name** column to select all of the different variations of "Morrisons"

![Image selecting Payees](https://actualbudget.org/assets/images/PayeesSelected-3b65103fbe1c0b2888be19d3f3da43ba.webp)

4. Click the button in the top-left to open the menu, and select **Merge**

![Image merging payees](https://actualbudget.org/assets/images/MergePayeesOption-31956d0ee74d2b382c68a85c4473d1d2.webp)
...
![Image of merged Payee](https://actualbudget.org/assets/images/PayeesMerged-3fee2f20fe2bd8d44c7cc38c1cbb1e2a.webp)
...
## Transfer Payees [​](https://actualbudget.org/docs/transactions/payees/\#transfer-payees "Direct link to Transfer Payees")

[Transfers](https://actualbudget.org/docs/transactions/transfers) are just special payees that indicate which account to transfer to/from. Since they are payees, you can create rules like normal which will automatically create transfers. You will find them at the bottom of the **Payees** page if you want to create custom rules.

![Image of Payee Page with transfers](https://actualbudget.org/assets/images/payee-transfers-233520ab93ed26b0c8f1b9218de64d3a.webp)

- [How Payees Work](https://actualbudget.org/docs/transactions/payees/#how-payees-work)
- [Editing a Payee](https://actualbudget.org/docs/transactions/payees/#editing-a-payee)
- [Merging Payees](https://actualbudget.org/docs/transactions/payees/#merging-payees)
- [Transfer Payees](https://actualbudget.org/docs/transactions/payees/#transfer-payees)